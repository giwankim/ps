...
fun main() {
    ...
    val intElements = IntArray(100_000_000)
    for (i in 0 until 100_000_000 - 1) {
        intElements[i] = 1
    }
    intElements[100_000_000 - 1] = 2
    ...
    // Array<Int?> 1억 개 삽입
    startTime = System.currentTimeMillis()
    val integerElements = arrayOfNulls<Int?>(100_000_000)
    for (i in 0 until 100_000_000 - 1) {
        integerElements[i] = 1
    }
    integerElements[100_000_000 - 1] = 2
