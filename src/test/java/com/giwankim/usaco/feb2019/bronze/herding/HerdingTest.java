...
import com.giwankim.support.ResourceUtils;
...
class HerdingTest {
  @ParameterizedTest
  @MethodSource
  void herding(String input, String output) throws URISyntaxException, IOException {
    String prefix = "com/giwankim/usaco/feb2019/bronze/herding/";
    ...
    Herding.herding(r, pw);

    assertThat(out).hasToString(Files.readString(outputPath));
  }

  private static Stream<Arguments> herding() {
    return Stream.of(
