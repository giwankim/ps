 ...
 * {@link #nextInt()} and friends to read, {@code println}/{@code printf} (inherited from {@link
 * PrintWriter}) to write, and {@link #close()} once at the end to flush the buffered output.
 *
 ...
 * IOException} convention used across these solutions; and the USACO-style file-input constructor is
 * dropped because BOJ is purely stdin/stdout.
 *
