...
In the first line of input, the number of test cases C ( <= 200 ) is given. In each of the following C lines, a natural number N\_i is given. All input numbers are greater than 1, and less than or equal to 500,000 .
