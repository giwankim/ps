...
class MinimumGeneticMutationTest {
  ...
  void endGeneNotInBank() {
    assertThat(sut.minMutation("AACCGGTT", "AACCGGTA", new String[] {"AACCGGTC"})).isEqualTo(-1);
  }
  ...
  @Test
  void singleMutation() {
    assertThat(sut.minMutation("AACCGGTT", "AACCGGTA", new String[] {"AACCGGTA"})).isOne();
  }
  ...
  void multipleNeighborsAtSameLevel() {
    ...
    assertThat(
            sut.minMutation(
                "AAAAAAAA",
                "CAAAAAAC",
                new String[] {"AAAAAAAC", "AAAAAAAG", "AAAAAAAT", "CAAAAAAC"}))
        .isEqualTo(2);
  }
  ...
  void shortestAmongMultiplePaths() {
    ...
    assertThat(
            sut.minMutation(
                "AACCGGTT",
                "AAACGGTA",
                new String[] {"AACCGGTA", "AACCGGTC", "AACCGGCA", "AAACGGTA"}))
        .isEqualTo(2);
  }
}
