...
class SearchInsertPositionTest {
  ...
  void singleElementEqualToTargetReturnsZero() {
    ...
    assertThat(sut.searchInsert2(new int[] {5}, 5)).isZero();
  }
  ...
  void singleElementGreaterThanTargetReturnsZero() {
    ...
    assertThat(sut.searchInsert2(new int[] {5}, 3)).isZero();
  }
  ...
  void singleElementLessThanTargetReturnsLength() {
    ...
    assertThat(sut.searchInsert2(new int[] {5}, 7)).isEqualTo(1);
  }
  ...
  void twoElementsTargetMatchesFirst() {
    ...
    assertThat(sut.searchInsert2(new int[] {3, 7}, 3)).isZero();
  }
  ...
  void twoElementsTargetMatchesLast() {
    ...
    assertThat(sut.searchInsert2(new int[] {3, 7}, 7)).isEqualTo(1);
  }
  ...
  void twoElementsTargetBetweenInsertsAtMiddle() {
    ...
    assertThat(sut.searchInsert2(new int[] {3, 7}, 5)).isEqualTo(1);
  }
  ...
  void targetSmallerThanAllReturnsZero() {
    ...
    assertThat(sut.searchInsert2(new int[] {2, 4, 6, 8}, 1)).isZero();
  }
  ...
  void targetLargerThanAllReturnsLength() {
    ...
    assertThat(sut.searchInsert2(new int[] {2, 4, 6, 8}, 10)).isEqualTo(4);
  }
  ...
  void targetMatchesMiddleOfOddSizedArray() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 7, 9}, 5)).isEqualTo(2);
  }
  ...
  void targetInGapBetweenInteriorElementsInsertsAtGap() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 7, 9}, 6)).isEqualTo(3);
  }
  ...
  void leetCodeExampleOneTargetFound() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 6}, 5)).isEqualTo(2);
  }
  ...
  void leetCodeExampleTwoTargetInsertsInGap() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 6}, 2)).isEqualTo(1);
  }
  ...
  void leetCodeExampleThreeTargetBeyondAll() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 6}, 7)).isEqualTo(4);
  }
  ...
  void leetCodeExampleFourTargetBeforeFirst() {
    ...
    assertThat(sut.searchInsert2(new int[] {1, 3, 5, 6}, 0)).isZero();
  }
  ...
  void negativeValuesInsertedInCorrectGap() {
    ...
    assertThat(sut.searchInsert2(new int[] {-5, -2, 0, 3}, -3)).isEqualTo(1);
  }
}
