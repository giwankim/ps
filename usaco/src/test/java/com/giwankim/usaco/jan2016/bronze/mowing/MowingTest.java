package com.giwankim.usaco.jan2016.bronze.mowing;
...
class MowingTest {
  ...
  @MethodSource
  void mowing(Path input, Path output) throws IOException {
  ...
  private static Stream<Arguments> mowing() {
    String prefix = "usaco/jan2016/bronze/mowing/";
